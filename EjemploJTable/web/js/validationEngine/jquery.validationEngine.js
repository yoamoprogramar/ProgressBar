    ...
    var methods = {
        ...
        init: function(options) {
            ...
            if (!form.data('jqv') || form.data('jqv') == null ) {
                ...
                //COMENTADO LO DE ABAJO PARA QUE GUARDE EL JTABLE A LA PRIMERA VEZ//JTABLE ERROR
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "minSize":
                        ...
                        break;
                    case "fixedSize":
                        errorMsg = methods._fixedSize(field, rules, i, options);
                        break;
                    case "maxSize":
         ...
         * @param {type} i
         * @param {type} options
         * @returns {options.allrules.min.alertText|options.allrules.min.alertText2|_L13.methods._min.min}
         */
        _fixedSize: function(field, rules, i, options) {
            var min = rules[i + 1];
            var len = field.val().length;
